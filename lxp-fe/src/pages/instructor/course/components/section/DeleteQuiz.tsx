...
interface DeleteQuizConfirmProps {
  onClose: () => void;
  onConfirm: (quizId: string) => Promise<void>;
  isLoading?: boolean;
  quiz: {
    id: string;
    title: string;
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-md">
        ...
        <div className="p-6">
          ...
          <p className="font-medium text-gray-800 mb-4">"{quiz.title}"</p>

          <div className="bg-yellow-50 p-3 rounded-lg text-yellow-800 text-sm mb-4">
            <p>
              This action will permanently delete this quiz and all associated
