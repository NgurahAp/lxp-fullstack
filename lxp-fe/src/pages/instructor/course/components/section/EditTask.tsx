...
const EditTaskForm: React.FC<EditTaskFormProps> = ({
  ...
  const [taskQuestion, setTaskQuestion] = useState(task.taskQuestion);
  const [isSubmitting, setIsSubmitting] = useState(false);

  useEffect(() => {
    // Initialize form with existing task data
    setTitle(task.title);
    setTaskQuestion(task.taskQuestion);
  }, [task]);
        ...
        <div className="bg-gray-50 p-4 border-t">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-gray-600">
              ...
              <p>
                Be clear and specific with your task question to ensure student understand exactly what's expected of them.
              </p>
            </div>
          </div>
        </div>
